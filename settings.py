"""
Django settings for collecte_données project.
...
SECRET_KEY = 'django-insecure-j50@ium=*e!dh7b3$-vw*^1pi31!+m(1th2x$$q-n(#ed&+k3-'
...
ROOT_URLCONF = 'collecte_données.urls'
...
WSGI_APPLICATION = 'collecte_données.wsgi.application'
